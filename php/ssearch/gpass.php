...
<tr>
<td><b>Received Date: </b></td><td><?php echo $eddate = date('d-m-Y', strtotime( $row['eddate'] )); ?></td>
</tr>
<tr>
<td><b>Received Ref: </b></td><td><?php echo $row['rdetail'];?></td>
</tr>
<tr>
<td><b>Contact:  </b></td><td>Mr/Mrs <?php echo $row['cpname'];?></td><td><b>Mobile: </b></td><td colspan=2;><?php echo $row['cpmobile'];?></td><td><b>Initiated By: </b></td><td>Mr/Mrs <?php echo $row['pby'];?></td>
</tr>
<tr>
<td colspan=5;></td><td><b>Initiated on: </b></td><td colspan=2;><?php echo $row['pbyt'];?></td>
</tr>
...
<tr>
<td><b>Approver Ack</b></td><td><?php echo $row['nrpabyt'];?></td>
<td><b>Maintenance/Store Ack on</b></td><td><?php echo $row['nrmsbyt'];?></td>
<td><b>Received on</b></td><td><?php echo $row['nrcbyt'];?></td>
</tr>
