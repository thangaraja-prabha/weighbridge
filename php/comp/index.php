...
$ins_query="insert into mlog (`dept`,`item_description1`,`nop`,`stdate`,`stime`,`sused`,`stat`,`remarks`,`username`,`trn_date`) 
                            values ('$dept','$item_description1','$nop','$stdate','$stime','$sused','$stat','$remarks','$username','$trn_date')";
...
<tbody>
<tr>
<td align="center" bgcolor="A7AFB0" colspan=4><strong>COMPLAINT REGISTER</strong></td>
</tr>
</thead>
<tbody>
<tr>
...
<select name="username" required >
    ...
    <?php
        ...
        $records = mysqli_query($con, "SELECT * From users  Where not rights='Admins' ");
