...
//$item=$_REQUEST['item'];	
	$query=mysqli_query($con, "Select * from punch where submittedby='".$submittedby."' AND datetime between '".$stdate."' AND '".$eddate."' ");
...
<td align="left"><?php echo $row["punchindate"]; ?></td>
